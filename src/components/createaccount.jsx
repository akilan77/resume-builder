        ...
        <Account_Wrapper >
            ...
            <Account_details id="print">
                ...
                <Account_content >
                   ...
                   <Link to="/"><Create_button onClick={create}>Create Account</Create_button></Link>
                </Account_content>
            </Account_details>
        </Account_Wrapper>  
    );
